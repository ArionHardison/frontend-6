                    ...
                    <div id="contacts" class="block">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                ...
                                <p class="mt-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae.</p>
                            </div>
...
<script>
    ...
    export default {
        ...
        metaInfo: {
            title: 'Contacts | Oxer - Minimal Portfolio Vue JS Template',
            titleTemplate: '%s'
        }
    }
</script>
