                                    ...
                                    <div class="header-right d-flex justify-content-end">
                                        <div class="d-flex align-items-center">
                                            <div class="search-close-toggle">
                                                <button @click="closeModal" type="button" class="close btn btn-lg btn-link border-0 p-0 min-w-auto" data-dismiss="modal" aria-label="Close"><i class="forch-icon-close"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    import SearchFormPrimary from '../Forms/SearchFormPrimary';
